...
class ProducerController extends Controller implements ICrud
{
    private $table_name;

    protected $producerService;

    public function __construct(ProducerServiceInterface $producerService)
    {
    ...
    {
        return $this->producerService->readAll();
    }

    public function readOne($id)
    {
        return $this->producerService->readOne($id);
    }

    public function createOne($data)
    {
        return $this->producerService->createOne($data);
    }

    public function updateOne($data)
    {
        return $this->producerService->updateOne($data);
    }

    public function deactivateOne($id)
    {
        return $this->producerService->deactivateOne($id);
    }
    ...
    {
        return $this->producerService->searchOne($filter);
    }
