...
trait FileHelper
{
    ...
    public function downloadFileFromBlade($data, $view, $title = '', $type = 'csv')
    {
        return Excel::create('Filename', function ($excel) use ($data, $view, $title) {

            $excel->sheet('Sheetname', function ($sheet) use ($data, $view, $title) {
