...
@Component({
    selector: 'app-report-supplier-total',
    templateUrl: './total.component.html',
    styles: []
})
export class ReportSupplierTotalComponent implements OnInit
    ...
    public setup_by_date: any = {
        link: 'report-suppliers/report-totals/detail-by-date',
        json_name: 'reports'
    };
    public setup_by_distributor: any = {
        link: 'report-suppliers/report-totals/detail-by-distributor',
        json_name: 'reports'
    };
    public setup_by_product: any = {
        link: 'report-suppliers/report-totals/detail-by-product',
        json_name: 'reports'
    };
    public setup_by_cabinet: any = {
        link: 'report-suppliers/report-totals/detail-by-cabinet',
        json_name: 'reports'
    };
    ...
    public header_master_by_distributor: any = {
        name: {
            title: "Đại lý",
            data_type: 'TEXT'
        }
    ...
    public header_detail_by_distributor: any = {
        date_output: {
            title: "Ngày",
            data_type: 'DATETIME',
            prop_name: 'created_date'
    ...
    public detail_by_distributor: any[] = [];
